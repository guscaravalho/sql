WITH
    flex_values AS
        (SELECT 
            ...
            ,fv.flex_value_id
            ,fv.flex_value
            ,SUBSTR(fv.flex_value,1,5)  AS cost_center_range
            ,REGEXP_SUBSTR(fv.flex_value, '[^-]+',1,2)  AS author_position_name
            ,fv.flex_value_meaning      AS cost_center_range_name
            ...
            ,fv.created_by
            ,fv.value_category
            ,fv.attribute1                  AS approval_level
            ,fv.attribute2                  AS approver_type
        ...
        WHERE 
            fvs.flex_value_set_name = 'ACG_PO_APPROVAL_MATRIX_VS')
...
SELECT
    fv.flex_value_id
    ,'PO Workflow L1S1 By Cost Center'       AS workflow_name
    ,fv.department
    ,fv.cost_center_range
    ,fv.cost_center_range_name
    ,(CASE
    ...
    ,fv.approval_level
    ,fv.dollar_limit
    ,p.position_name_concat                 AS approver_position
    ,fv.rule_status
    ,fv.rule_validity
    ,fv.valid_start_date
    ,fv.valid_end_date
